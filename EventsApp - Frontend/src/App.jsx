...
import { API_SERVICES } from "./config/api";
...
const ENTITIES = [
  {
    ...
    icon: "Events",
    api: {
      baseUrl: API_SERVICES.events.baseUrl,
      path: "events",
    },
    fields: {
      response: [
    ...
    fieldLabels: {
      ...
      naziv: "Name",
      agenda: "Agenda",
      datumVreme: "Date & Time",
      trajanje: "Duration (min)",
      cena: "Price",
      nazivLokacije: "Location",
      nazivTipa: "Type",
      nazivOrganizatora: "Organizer",
      lokacijaId: "Location ID",
      tipId: "Type ID",
      organizatorId: "Organizer ID",
    },
    fieldTypes: {
      datumVreme: "datetime-local",
      trajanje: "number",
      cena: "number",
      lokacijaId: "number",
      tipId: "number",
  ...
  },
  {
    ...
    fieldLabels: {
      id: "ID",
      rasporedPredavanja: "Schedule",
      imePrezimePredavaca: "Speaker",
      nazivDogadjaja: "Event",
      predavacId: "Speaker ID",
      strucniDogadjajId: "Event ID",
    },
    fieldTypes: {
      rasporedPredavanja: "datetime-local",
      predavacId: "number",
      strucniDogadjajId: "number",
    },
  },
  {
    key: "visitors",
    ...
    icon: "Visitors",
    api: {
      baseUrl: API_SERVICES.visitors.baseUrl,
      path: "posetioci",
    },
    fields: {
      response: ["id", "ime", "prezime", "statusZaposlenja", "interesovanje", "dogadjajId", "listaDogadjaja"],
      request: ["ime", "prezime", "statusZaposlenja", "interesovanje", "dogadjajId"],
    },
    fieldLabels: {
      id: "ID",
      ime: "First Name",
      prezime: "Last Name",
      statusZaposlenja: "Employment",
      interesovanje: "Interest",
      dogadjajId: "Event ID",
      listaDogadjaja: "Events",
    },
    fieldTypes: { dogadjajId: "number" },
  },
];
